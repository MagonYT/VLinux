...
ApplicationWindow {
    ...
    property var pages: ["hardware", "ssd", "network", "input", "logs", "details"]
    property var labels: ["Hardware", "SSD", "Network", "Input", "Boot Logs", "Power & USB"]
    property string reportText: "Waiting for hardware report…"
    property string updated: "Waiting for first snapshot"
    property int requestId: 0
    property bool paused: false
    property int reportFontSize: 17
    ...
    Timer { interval: 5000; running: !app.paused; repeat: true; onTriggered: app.refresh() }
    ...
    Shortcut { sequence: "Alt+6"; onActivated: tabs.currentIndex = 5 }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label { text: "DIAGNOSTICS  /  " + app.buildId; color: "#96bdff"; font.pixelSize: 14 }
        }
        Label {
        ...
        ScrollView {
            ...
            TextArea {
                ...
                font.pixelSize: app.reportFontSize
                padding: 18
                background: Rectangle { color: "#111620"; radius: 8 }
            }
        }
        Label { text: app.updated + (app.paused ? "  ·  Updates paused" : ""); color: "#b3bed0"; font.pixelSize: 13 }
        RowLayout {
            Layout.fillWidth: true
            Item { Layout.fillWidth: true }
            Label { text: "Alt+1…6 switches pages"; color: "#b3bed0"; font.pixelSize: 13 }
            Button { text: "A−"; enabled: app.reportFontSize > 13; onClicked: app.reportFontSize-- }
            Button { text: "A+"; enabled: app.reportFontSize < 26; onClicked: app.reportFontSize++ }
            Button { text: "Pause updates"; checkable: true; onToggled: app.paused = checked }
            Button { text: "Copy report"; onClicked: { report.selectAll(); report.copy(); report.deselect(); } }
